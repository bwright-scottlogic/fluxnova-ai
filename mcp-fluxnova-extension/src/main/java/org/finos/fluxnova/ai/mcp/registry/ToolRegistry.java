package org.finos.fluxnova.ai.mcp.registry;
...
public class ToolRegistry {
    ...
    public boolean register(ToolConfig config) {
        ...
        try {
            ...
            LOG.error("Failed to register tool: {}", config.name(), e);
            return false;
        }
    }
    ...
    public boolean unregister(String toolName) {
        ...
        try {
            ...
            LOG.error("Failed to unregister tool: {}", toolName, e);
            return false;
        }
    }
    ...
    public void unregisterAll() {
        LOG.info("Unregistering all {} tools", registeredTools.size());
        ...
        return new SyncToolSpecification(
                ...
                (exchange, arguments) -> {
                    try {
                        ...
                        LOG.error("Tool '{}' execution failed", config.name(), e);
                        return new CallToolResult(
    ...
    private String formatResult(Object result) {
        ...
        try {
            ...
            LOG.warn("Failed to serialize result to JSON, using toString()", e);
