...
public class ProcessStarter {
    ...
    public Map<String, Object> startProcess(ToolDefinition definition, Map<String, Object> arguments) {
        try {
            LOG.info("Starting process '{}' via MCP tool '{}' with args: {}", definition.processId(), definition.toolName(), arguments);

            String businessKey = arguments.get("businessKey") != null ? arguments.get("businessKey").toString() : null;
            ...
            LOG.info("Process instance created: {} for tool '{}' with business key '{}'",
            ...
            LOG.error("Failed to start process '{}' via tool '{}'",
